...
class ROICalculator:
    def __init__(self):
        # Base salary data by field and pathway (USD, annual)
        self.salary_data = {
            'Technology & Software': {
                'International University': {'starting': 75000, 'growth_rate': 0.12},
                'Local University': {'starting': 65000, 'growth_rate': 0.10},
                'Apprenticeship': {'starting': 45000, 'growth_rate': 0.15},
                'Micro-Credentials': {'starting': 55000, 'growth_rate': 0.18}
            },
            'Business & Finance': {
                'International University': {'starting': 70000, 'growth_rate': 0.10},
                'Local University': {'starting': 58000, 'growth_rate': 0.09},
                'Apprenticeship': {'starting': 38000, 'growth_rate': 0.12},
                'Micro-Credentials': {'starting': 48000, 'growth_rate': 0.15}
            },
            'Healthcare & Medicine': {
                'International University': {'starting': 65000, 'growth_rate': 0.08},
                'Local University': {'starting': 60000, 'growth_rate': 0.08},
                'Apprenticeship': {'starting': 42000, 'growth_rate': 0.10},
                'Micro-Credentials': {'starting': 45000, 'growth_rate': 0.12}
            },
            'Engineering & Manufacturing': {
                'International University': {'starting': 72000, 'growth_rate': 0.09},
                'Local University': {'starting': 64000, 'growth_rate': 0.09},
                'Apprenticeship': {'starting': 48000, 'growth_rate': 0.13},
                'Micro-Credentials': {'starting': 52000, 'growth_rate': 0.14}
            },
            'Creative Arts & Design': {
                'International University': {'starting': 45000, 'growth_rate': 0.08},
                'Local University': {'starting': 42000, 'growth_rate': 0.07},
                'Apprenticeship': {'starting': 35000, 'growth_rate': 0.12},
                'Micro-Credentials': {'starting': 40000, 'growth_rate': 0.15}
            },
            'Education & Social Services': {
                'International University': {'starting': 48000, 'growth_rate': 0.06},
                'Local University': {'starting': 45000, 'growth_rate': 0.06},
                'Apprenticeship': {'starting': 32000, 'growth_rate': 0.08},
                'Micro-Credentials': {'starting': 38000, 'growth_rate': 0.10}
            },
            'Science & Research': {
                'International University': {'starting': 62000, 'growth_rate': 0.08},
                'Local University': {'starting': 55000, 'growth_rate': 0.08},
                'Apprenticeship': {'starting': 40000, 'growth_rate': 0.10},
                'Micro-Credentials': {'starting': 48000, 'growth_rate': 0.12}
            },
            'Trades & Construction': {
                'International University': {'starting': 52000, 'growth_rate': 0.07},
                'Local University': {'starting': 48000, 'growth_rate': 0.07},
                'Apprenticeship': {'starting': 42000, 'growth_rate': 0.14},
                'Micro-Credentials': {'starting': 45000, 'growth_rate': 0.13}
            }
        }
        
        # Education costs by pathway and country
        self.education_costs = {
            'International University': {
                'USA': {'tuition': 45000, 'living': 18000, 'duration_years': 4},
                'UK': {'tuition': 35000, 'living': 15000, 'duration_years': 3},
                'Canada': {'tuition': 28000, 'living': 14000, 'duration_years': 4},
                'Australia': {'tuition': 32000, 'living': 16000, 'duration_years': 3},
                'Germany': {'tuition': 3000, 'living': 12000, 'duration_years': 3},
                'Local/Home Country': {'tuition': 25000, 'living': 12000, 'duration_years': 4}
            },
            'Local University': {
                'USA': {'tuition': 12000, 'living': 12000, 'duration_years': 4},
                'UK': {'tuition': 10000, 'living': 10000, 'duration_years': 3},
                'Canada': {'tuition': 8000, 'living': 10000, 'duration_years': 4},
                'Australia': {'tuition': 9000, 'living': 11000, 'duration_years': 3},
                'Germany': {'tuition': 500, 'living': 10000, 'duration_years': 3},
                'Local/Home Country': {'tuition': 8000, 'living': 8000, 'duration_years': 4}
            },
            'Apprenticeship': {
                'default': {'tuition': -15000, 'living': 0, 'duration_years': 2}  # Negative = earning
            },
            'Micro-Credentials': {
                'default': {'tuition': 12000, 'living': 0, 'duration_years': 0.5}  # 6 months
            }
        }
